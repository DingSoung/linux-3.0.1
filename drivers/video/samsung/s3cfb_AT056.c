...
#define S3CFB_HFP		16//40	/* front porch */
#define S3CFB_HSW		10//48	/* hsync width */
#define S3CFB_HBP		144//40	/* back porch */

#define S3CFB_VFP		32//13	/* front porch */
#define S3CFB_VSW		2//3	/* vsync width */
#define S3CFB_VBP		13//29	/* back porch */
...
void s3cfb_init_hw_56(void)
{
	printk(KERN_INFO "LCD TYPE :: L70T84 will be initialized\n");
