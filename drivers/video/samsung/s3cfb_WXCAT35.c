...
#define S3CFB_HSW		8//48	/* hsync width */
#define S3CFB_HBP		68//40	/* back porch */

#define S3CFB_VFP		5//13	/* front porch */
#define S3CFB_VSW		15//3	/* vsync width */
#define S3CFB_VBP		18//29	/* back porch */
