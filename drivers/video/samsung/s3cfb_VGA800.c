...
#include "s3cfb.h"
#if 1
#define S3CFB_HFP		55//40	/* front porch */
#define S3CFB_HSW		119//48	/* hsync width */
#define S3CFB_HBP		73//40	/* back porch */

#define S3CFB_VFP		36//13	/* front porch */
#define S3CFB_VSW		5//3	/* vsync width */
#define S3CFB_VBP		32//29	/* back porch */
#else
#define S3CFB_HFP		15//40	/* front porch */
#define S3CFB_HSW		95//48	/* hsync width */
#define S3CFB_HBP		47//40	/* back porch */

#define S3CFB_VFP		12//13	/* front porch */
#define S3CFB_VSW		4//3	/* vsync width */
#define S3CFB_VBP		16//29	/* back porch */
#endif
...
#define S3CFB_VFRAME_FREQ     	30	/* frame rate freq */
...
void s3cfb_init_hw_vga800(void)
{
	printk(KERN_INFO "LCD TYPE :: VGA800 will be initialized\n");
