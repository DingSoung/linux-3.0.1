...
#define S3CFB_HFP		40//40	/* front porch */
#define S3CFB_HSW		119//48	/* hsync width */
#define S3CFB_HBP		40//40	/* back porch */
...
#define S3CFB_VRES_VIRTUAL	S3CFB_HRES	/* line cnt       y resolution */

#define S3CFB_HRES_OSD		S3CFB_HRES	/* horizon pixel  x resolition */
#define S3CFB_VRES_OSD		S3CFB_HRES	/* line cnt       y resolution */
...
void s3cfb_init_hw_xga1024(void)
{
	printk(KERN_INFO "LCD TYPE :: XGA1024 will be initialized\n");
