		...
		int cmd, unsigned long arg)
{
	...
	case S3C_CMM_IOCTL_CODEC_CACHE_INVALIDATE:
		...
		//dma_cache_maint(start,codec_cache_flush_arg.size,DMA_FROM_DEVICE);
                ...
                dma_map_single(NULL, start, codec_cache_flush_arg.size, DMA_FROM_DEVICE);
	...
	case S3C_CMM_IOCTL_CODEC_CACHE_CLEAN:
		...
		//dma_cache_maint(start,codec_cache_flush_arg.size,DMA_TO_DEVICE);
                dma_map_single(NULL, start, codec_cache_flush_arg.size, DMA_TO_DEVICE);
                //dma_cache_maint_page(start, codec_cache_flush_arg.size, DMA_TO_DEVICE);
	...
	case S3C_CMM_IOCTL_CODEC_CACHE_CLEAN_INVALIDATE:
		...
		//dma_cache_maint(start,codec_cache_flush_arg.size,DMA_BIDIRECTIONAL);
                //dma_map_single(0,start, codec_cache_flush_arg.size, DMA_BIDIRECTIONAL);
                dma_map_single(NULL, start, codec_cache_flush_arg.size, DMA_BIDIRECTIONAL);
