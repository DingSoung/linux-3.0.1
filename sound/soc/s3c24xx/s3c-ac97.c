				  ...
				  struct snd_soc_dai *dai)
{
	...
	struct s3c_dma_params *dma_data;
		...
		printk("\n@@@@@@@@@@@@@@@@@@@@\n");
		printk("s3c_ac97_hw_params 22222222222222");
		printk("\n@@@@@@@@@@@@@@@@@@@@\n");
...
int test123(struct snd_pcm_substream *substream,struct snd_soc_dai *dai)
{
